...
Once the `conda-forge` channel has been enabled, `apache-beam, apache-beam-with-aws, apache-beam-with-azure, apache-beam-with-dask, apache-beam-with-dataframe, apache-beam-with-gcp, apache-beam-with-tensorflow, apache-beam-with-tensorflow-hub, apache-beam-with-torch, apache-beam-with-yaml` can be installed with `conda`:

```
conda install apache-beam apache-beam-with-aws apache-beam-with-azure apache-beam-with-dask apache-beam-with-dataframe apache-beam-with-gcp apache-beam-with-tensorflow apache-beam-with-tensorflow-hub apache-beam-with-torch apache-beam-with-yaml
```

or with `mamba`:

```
mamba install apache-beam apache-beam-with-aws apache-beam-with-azure apache-beam-with-dask apache-beam-with-dataframe apache-beam-with-gcp apache-beam-with-tensorflow apache-beam-with-tensorflow-hub apache-beam-with-torch apache-beam-with-yaml
```
